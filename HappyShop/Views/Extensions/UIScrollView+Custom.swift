...
extension UIScrollView : UIScrollViewDelegate {
    ...
    public func scrollViewDidScroll(scrollView: UIScrollView) {
        ...
        let isProductsCollectionView = (self.isKind(of: ProductsCollectionView.classForCoder())) as Bool
        let isProductsTableView = (self.isKind(of: ProductsTableView.classForCoder())) as Bool
